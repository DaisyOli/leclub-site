...
Site institucional da LeCLUB Fitness & Wellness, um studio boutique de fitness e wellness no Alto de Pinheiros, São Paulo. Construído para apresentar a marca e levar visitantes qualificados até a matrícula, via WhatsApp e a plataforma de vendas do studio.

**Site no ar**: [leclubfw.com](https://www.leclubfw.com/)

## Visão geral

A LeCLUB é um espaço de treino de capacidade limitada que combina treinamento de força com serviços clínicos e de recuperação (consultas médicas, avaliação de composição corporal, banheira de gelo, terapia de compressão). O site tem um objetivo específico: comunicar esse posicionamento com clareza e levar visitantes qualificados até uma conversa.
...
- **Estrutura de conteúdo**: as seções giram em torno de cuidado, técnica e continuidade ("Sobre", "Local"), não em torno de promoções ou grade de horários.
- **Caminho de conversão**: preços e matrícula acontecem na própria plataforma de vendas do studio, em vez de um checkout embutido na página. Os CTAs do site (navbar, footer, botão flutuante de WhatsApp) apontam para essa plataforma ou abrem uma conversa no WhatsApp, mantendo a experiência no site focada em marca e espaço físico.
...
- Navegação por âncoras (`#sobre`, `#local`) com scroll suave
